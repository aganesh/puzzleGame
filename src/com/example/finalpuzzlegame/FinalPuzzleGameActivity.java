package com.example.finalpuzzlegame;
...
public class FinalPuzzleGameActivity extends Activity {
	FinalPuzzleGame tpGame = new FinalPuzzleGame();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_final_puzzle_game);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.final_puzzle_game, menu);
		return true;
	}
